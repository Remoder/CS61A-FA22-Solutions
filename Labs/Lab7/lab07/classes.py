...
class Player:
    ...
    def play(self, index):
        ...
        """
        "*** YOUR CODE HERE ***"
        assert len(self.hand) > 0, "No card in hand!"
        card = self.hand[0]
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        added = True if player.hand else False
        # You should add your implementation above this.
        if added:
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        """
        "*** YOUR CODE HERE ***"
        best_card = max([[x.power(opponent_card), x] for x in player.hand])[1] if player.hand else None
        # You should add your implementation above this.
        if best_card:
